class Monster < ActiveRecord::Base
	...
	has_attached_file :avatar_skill_1, styles: { medium: "300x300>", thumb: "100x100>" }
	has_attached_file :avatar_skill_2, styles: { medium: "300x300>", thumb: "100x100>" }
	has_attached_file :avatar_skill_3, styles: { medium: "300x300>", thumb: "100x100>" }
	has_attached_file :avatar_skill_4, styles: { medium: "300x300>", thumb: "100x100>" }
